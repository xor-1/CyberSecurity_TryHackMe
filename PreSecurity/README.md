...
> pseudo-code, i.e., English language that is closer to the programming language.

We made a game in which user guesses a number chosen by the system and outputs the result to user. It was a great learning experience. The source code of the game will be shared here.

In this room, I covered three key pillars in imperative programming languages:
- Variables
